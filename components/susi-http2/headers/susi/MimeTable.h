...
#ifndef __MIMETABLE__
#define __MIMETABLE__
...
public:
    static std::string getContentType(std::string filename) {
        ...
        if(dotPosition != std::string::npos) {
            ...
            try{
                contentType = mimeTable.at(extension);
            }catch(...){
...
protected:
    static const std::map<std::string,std::string> mimeTable;
    
};

const std::map<std::string,std::string> MimeTable::mimeTable{
